...
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white sticky top-0">
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm font-bold">Philippines</span>
                </div>
                <div class="w-full text-gray-800 md:text-center text-2xl font-bold">
                    Five Sec 
                </div>
