...
<div x-data="{show : true}" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="bg-orange-100 m-2 fixed bottom-0 right-0 z-20 border-t-4 border-orange-500 rounded-b text-orange-900 px-4 py-3 shadow-md" role="alert">
    <div class="flex">
      ...
      <div>
        ...
        <p class="text-sm">{{session('warning_msg')}}</p>
      </div>
    </div>
  </div>
