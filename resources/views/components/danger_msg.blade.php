...
<div x-data="{show : true}" x-show="show" x-init="setTimeout(() => show = false, 5000)" class="bg-red-100 m-2 fixed bottom-0 right-0 z-20 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
    <div class="flex">
      ...
      <div>
        ...
        <p class="text-sm">{{session('danger_msg')}}</p>
      </div>
    </div>
  </div>
